...
class PlansResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'icon-plan-icon';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
            Forms\Components\TextInput::make('name')->label('Plan Name'),
            Forms\Components\TextInput::make('amount')->label('Plan Amount'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('amount')->label('Plan Amount')->sortable(),
